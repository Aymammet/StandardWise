...
StandardWise is a practice app that helps students answer questions aligned to
learning standards, and lets teachers or administrators manage that practice
content and review progress.
...
We do not sell personal information and do not share it with third parties for
marketing.
...
Access to data is controlled by Firebase security rules: students can read
learning content and create only their own attempts and feedback, and only
administrators can read other users' data. Data is encrypted in transit.

## Changes to this policy

We will update this page and change the effective date when this policy
changes. Material changes affecting children's data will be communicated to
